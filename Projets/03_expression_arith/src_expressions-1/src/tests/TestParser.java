...
public class TestParser {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("-----------------------");
            System.out
                .println("Veuillez saisir les valeurs de toutes les variables (environnement)");
            System.out
                .println("  Format : <variable> <valeur> <variable> <valeur> sur une seule ligne.");
            ...
            try {
                ...
                System.out
                    .print("Valeur de l'expression, compte tenu de l'environnement : ");
    ...
    static ExpAbstraite parser(Scanner sc) {
        if (!sc.hasNext()) {
            throw new RuntimeException(
                    "parsing impossible : il manque des operandes !");
        }
